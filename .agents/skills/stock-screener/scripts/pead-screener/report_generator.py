...
def generate_chinese_report(analysis: dict, output_file: str):
    """生成pead-screener 分析中文报告"""
    import json
    
    lines = []
    lines.append("# pead-screener 分析报告")
    lines.append("")
    ...
    lines.append("---")
    lines.append(f"*报告由 pead-screener 自动生成，支持美股/A股/港股多市场*")
    lines.append("")
