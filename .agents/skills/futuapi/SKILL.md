...
**示例**：假设要运行 `get_accounts.py`，skill base directory 为 `/home/user/.Codex/skills/futuapi`：
...
ls /home/user/.Codex/skills/futuapi/scripts/trade/get_accounts.py 2>/dev/null
```
