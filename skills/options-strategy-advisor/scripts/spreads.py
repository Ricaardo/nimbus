...
try:
    ...
    # trading_skills 未安装时，提供友好错误
    def _not_available(*args, **kwargs):
        return {"error": "trading_skills package not installed. Install with: pip install trading_skills"}
    analyze_diagonal = analyze_iron_condor = analyze_straddle = analyze_strangle = analyze_vertical = _not_available
