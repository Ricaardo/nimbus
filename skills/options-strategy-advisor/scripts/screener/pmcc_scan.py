...
try:
    ...
    # trading_skills 未安装时提供友好错误
    def analyze_pmcc(*args, **kwargs):
        return None
    def format_scan_results(results):
        return {"error": "trading_skills package not installed. Install with: pip install trading_skills", "results": []}
