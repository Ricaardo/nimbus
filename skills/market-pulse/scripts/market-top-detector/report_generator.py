...
def generate_chinese_report(analysis: dict, output_file: str):
    """生成market-top-detector 分析中文报告"""
    import json
    
    lines = []
    lines.append("# market-top-detector 分析报告")
    lines.append("")
    ...
    lines.append("---")
    lines.append(f"*报告由 market-top-detector 自动生成，支持美股/A股/港股多市场*")
    lines.append("")
