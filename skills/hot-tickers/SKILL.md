...
## 用法
```bash
python3 ~/.claude/skills/hot-tickers/scripts/hot_tickers.py               # 跨源热度榜 top20
python3 ~/.claude/skills/hot-tickers/scripts/hot_tickers.py --top 30
python3 ~/.claude/skills/hot-tickers/scripts/hot_tickers.py --ticker NVDA    # 某票在各源的热度
python3 ~/.claude/skills/hot-tickers/scripts/hot_tickers.py --source apewisdom  # 单源原始榜
```
