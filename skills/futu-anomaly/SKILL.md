---
name: futu-anomaly
description: 个股多维异动一站式（合并 资金/技术/衍生品 三维，futu OpenD）。资金面(资金流向/主力/大单/卖空/经纪商) + 技术面(K线形态/MACD/RSI/KDJ/金叉死叉/超买超卖) + 衍生品(牛熊证/期权大单/IV/PCR/smart money)。当用户问「X 异动/有没有异常/资金动向/主力进出/净流入流出/技术信号/形态/超买超卖/期权大单/隐含波动率/牛熊证/聪明钱押注」时触发。先把名字归一为 US.NVDA / HK.00700 格式。默认扫全部三维，可 --dim 指定。需 OpenD 在线(部分 unusual 数据需 futu 数据权限)。
---
