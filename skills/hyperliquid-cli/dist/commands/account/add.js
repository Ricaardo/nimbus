...
export function registerAddCommand(account) {
    account
        ...
        try {
            ...
            const setupMethod = await select("How would you like to add your account?", [
                {
                    value: "existing",
...
async function handleExistingWallet(isTestnet, outputOpts) {
...
async function handleReadOnly(outputOpts) {
