...
export function registerMarketCommand(order) {
    order
        .command("market")
        ...
        .action(async function (sideArg, sizeArg, coin, options) {
        ...
        try {
            ...
            const slippagePct = (options.slippage ? parseFloat(options.slippage) : config.slippage) / 100;
