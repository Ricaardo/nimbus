    ...
    order
        ...
        try {
            ...
            if (oidArg) {
                ...
                const orderToCancel = orders.find((o) => o.oid === orderId);
                if (!orderToCancel) {
                ...
                const selectedOrder = orders.find((o) => o.oid === orderId);
