...
description: 查个股内部人(高管/董事/10%股东)买卖披露(SEC Form 4)——谁在增减持、净方向。数据来自 Finnhub 免费端点。当用户问「X 内部人/高管增减持/内部人交易/insider trading/高管在买还是卖」时触发。需先把公司名/中文名归一为美股 ticker。NOT for: 13F 机构→institutional-flow-tracker；资金流/主力→futu-capital-anomaly。仅信息参考，非投资建议。
---
