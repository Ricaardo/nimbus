...
```bash
python3 ~/.claude/skills/us-screener/scripts/screener_us.py candidates --top 8
...
```bash
python3 ~/.claude/skills/us-screener/scripts/value_pipeline.py --market US --limit 40
